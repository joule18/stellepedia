...
const getUserProfile = async (req, res) => {
  ...
  //get user profile either by username or userId
  try {
    let user;
...
const updateUser = async (req, res) => {
  ...
  try {
    ...
    //find all posts that this user has replied on and update their details
...
const getSuggestedUsers = async (req, res) => {
  try {
    //exclude the current user from suggested users array, and other users already being followed
